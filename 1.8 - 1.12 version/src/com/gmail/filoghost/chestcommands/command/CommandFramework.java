	...
	public static class CommandValidate {
		...
		public static int getPositiveInteger(String input) {
			try {
				...
				if (i < 0) {
					throw new CommandException("O numero deve ser 0 ou positivo!");
				}
				return i;
			} catch (NumberFormatException e) {
				throw new CommandException("O numero \"" + input + "\" nao e um numero valido.");
			}
		}
		...
		public static int getPositiveIntegerNotZero(String input) {
			try {
				int i = Integer.parseInt(input);
				if (i <= 0) {
					throw new CommandException("O numero deve ser positivo!");
				}
				return i;
			} catch (NumberFormatException e) {
				throw new CommandException("O numero \"" + input + "\" nao e um numero valido.");
