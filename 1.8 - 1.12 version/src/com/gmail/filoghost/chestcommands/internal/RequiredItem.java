...
public class RequiredItem {
	...
	public RequiredItem(Material material, int amount) {
		Validate.notNull(material, "O Material nao pode ser nulo");
		Validate.isTrue(material != Material.AIR, "O Material nao pode ser o ar (AIR)");
	...
	public void setRestrictiveDataValue(short data) {
		Validate.isTrue(data >= 0, "A DataTag do item nao pode ser negativa");
