		...
		for (String singleEnchant : input.split(";")) {
			...
			if (singleEnchant.contains(",")) {
				...
				try {
					...
					errorLogger.addError("O icone \"" + iconName + "\" que esta no menu \"" + menuFileName + "\" possui um nivel de encatamento invalido: " + levelSplit[1]);
				}
			...
			if (ench == null) {
				errorLogger.addError("O icone \"" + iconName + "\" que esta no menu \"" + menuFileName + "\" possui um encantamento invalido: " + singleEnchant);
			} else {
