...
public class EconomyBridge {
	...
	public static Economy getEconomy() {
		if (!hasValidEconomy()) throw new IllegalStateException("Nenhum plugin de economia foi encontrado!");
		return economy;
	}
	...
	public static boolean hasMoney(Player player, double minimum) {
		if (!hasValidEconomy()) throw new IllegalStateException("Nenhum plugin de economia foi encontrado!");
		if (minimum < 0.0) throw new IllegalArgumentException("Quantia de dinehiro invalida: " + minimum);
	...
	public static boolean takeMoney(Player player, double amount) {
		if (!hasValidEconomy()) throw new IllegalStateException("Nenhum plugin de economia foi encontrado!");
		if (amount < 0.0) throw new IllegalArgumentException("Quantia de dinehiro invalida: " + amount);
