			...
			for (Field field : getClass().getDeclaredFields()) {
				...
				try {
					...
					if (defaultValue != null) {
						...
						config.getPlugin().getLogger().warning("O field " + field.getName() + " nao foi fornecido com o valor padrao. Por favor informe isto ao desenvolvedor!");
					}
		...
		for (Field field : getClass().getDeclaredFields()) {
			...
			if (config.isSet(configKey)) {
				...
				if (type == boolean.class || type == Boolean.class) {
					...
					config.getPlugin().getLogger().warning("Tipo de field desconhecido: " + field.getType().getName() + " (" + field.getName() + "). Por favor informe isto ao desenvolvedor!");
				}
